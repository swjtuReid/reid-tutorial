...
# number of attention maps for lagnet
_C.MODEL.NUM_ATTENTIONS = 32
...
_C.INPUT.PADDING = 10
# data augmentation method RE or CUT
_C.INPUT.DATA_AUGMENTATION = 'RE' 
# -----------------------------------------------------------------------------
# Dataset
# -----------------------------------------------------------------------------
_C.DATASETS = CN()
...
# weight of softmax loss
_C.SOLVER.SOFTMAX_WEIGHT = 1
