...
class ResNeXt(nn.Module):
    ...
    def load_param_author(self, model_path):
...
def resnext50_ibn_a(last_stride, baseWidth=4, cardinality=1):
    """
...
def resnext101_ibn_a(last_stride, baseWidth=4, cardinality=1):
    """
...
def resnext152_ibn_a(last_stride, baseWidth=4, cardinality=1):
    """
